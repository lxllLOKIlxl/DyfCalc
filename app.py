...
# Вибір мови
with st.sidebar:
    # Спочатку локалізований заголовок "Мова інтерфейсу"
    st.header("🌐 Мова інтерфейсу")  # Статичний текст для початкового відображення

    # Радіо-кнопка для вибору мови
    lang_choice = st.radio("Оберіть мову:", ["uk", "en"], key="language_radio")

    # Після вибору мови завантажуємо переклади
    translations = load_language(lang_choice)

    # Оновлюємо заголовок відповідно до вибраної мови
