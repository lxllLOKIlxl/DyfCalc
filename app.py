...
with st.sidebar:
    ...
    st.markdown(
        f"""
        <div style="background-color: #f9f9fc; padding: 8px; border-radius: 4px; border: 1px solid #ddd; margin-bottom: 5px;">
            <h4 style="color: #000; text-align: center; margin: 0;">🌐 {translations['interface_language']}</h4>
        </div>
